/** Isolated built-component fixture. Explicit routes only; no production APIs. */
...
const routes = new Map([
  ['/', { path: resolve(root, 'tests/browser/dual-model.html'), type: 'text/html; charset=utf-8' }],
...
server.listen(0, '127.0.0.1', () => console.log(`DUAL_MODEL_FIXTURE=http://127.0.0.1:${server.address().port}/`))
